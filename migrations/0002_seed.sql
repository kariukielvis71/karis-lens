-- Seed data (migrated from former src/services/mockData.js)

INSERT INTO business (id, name, whatsapp, email) VALUES
  (1, 'Karis Media Production', '254794891348', 'bookings@karismedia.co');
...
INSERT INTO content (id, kind, title, category, status, cover_url, date, description, linked_project_id) VALUES
